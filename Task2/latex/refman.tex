...
\doxysection{Иерархический список классов}
\input{hierarchy}
\doxysection{Алфавитный указатель классов}
\input{annotated}
\doxysection{Список файлов}
\input{files}
\doxysection{Классы}
\input{classCipher}
\input{classcipher__error}
\doxysection{Файлы}
\input{modAlphaCipher_8h}
